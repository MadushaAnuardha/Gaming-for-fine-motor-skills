...
public class GameTappingNormal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_tapping_normal);
    ...
    public void loadNext(){
        ...
        Intent intent = new Intent(this, GameTappingHard.class);
    ...
    public void loadLevel(){
        ...
        if( GameUtilities.gameLevel == 1){
            ...
            dot_3_1.setImageResource(R.drawable.tap_blue);
            dot_3_2.setImageResource(R.drawable.tap_blue);
            dot_3_3.setImageResource(R.drawable.tap_blue);
            dot_3_4.setImageResource(R.drawable.tap_blue);
            dot_3_5.setImageResource(R.drawable.tap_blue);
            dot_3_6.setImageResource(R.drawable.tap_blue);
            dot_4_1.setImageResource(R.drawable.tap_blue);
            dot_4_2.setImageResource(R.drawable.tap_blue);
            dot_4_5.setImageResource(R.drawable.tap_blue);
            dot_4_6.setImageResource(R.drawable.tap_blue);
            ...
            dot_2_3.setImageResource(R.drawable.tap_green);
            dot_2_4.setImageResource(R.drawable.tap_green);
            ...
            dot_1_1.setImageResource(R.drawable.tap_yellow);
            dot_1_6.setImageResource(R.drawable.tap_yellow);
            dot_2_2.setImageResource(R.drawable.tap_yellow);
            ...
            dot_3_5.setImageResource(R.drawable.tap_yellow);
            dot_4_1.setImageResource(R.drawable.tap_yellow);
            dot_4_6.setImageResource(R.drawable.tap_yellow);
            ...
            dot_1_4.setImageResource(R.drawable.tap_blue);
            dot_1_6.setImageResource(R.drawable.tap_blue);
            dot_2_1.setImageResource(R.drawable.tap_blue);
            dot_2_3.setImageResource(R.drawable.tap_blue);
            dot_2_5.setImageResource(R.drawable.tap_blue);
            dot_3_2.setImageResource(R.drawable.tap_blue);
            dot_3_4.setImageResource(R.drawable.tap_blue);
            dot_3_6.setImageResource(R.drawable.tap_blue);
            dot_4_1.setImageResource(R.drawable.tap_blue);
            dot_4_3.setImageResource(R.drawable.tap_blue);
            dot_4_5.setImageResource(R.drawable.tap_blue);

            dot_1_2.setVisibility(View.VISIBLE);
            dot_1_4.setVisibility(View.VISIBLE);
            dot_1_6.setVisibility(View.VISIBLE);
            dot_2_1.setVisibility(View.VISIBLE);
            dot_2_3.setVisibility(View.VISIBLE);
            dot_2_5.setVisibility(View.VISIBLE);
            dot_3_2.setVisibility(View.VISIBLE);
            dot_3_4.setVisibility(View.VISIBLE);
            ...
            dot_1_2.setImageResource(R.drawable.tap_red);
            dot_1_5.setImageResource(R.drawable.tap_red);
            dot_1_6.setImageResource(R.drawable.tap_red);
            dot_2_2.setImageResource(R.drawable.tap_red);
            dot_2_3.setImageResource(R.drawable.tap_red);
            dot_2_4.setImageResource(R.drawable.tap_red);
            dot_2_5.setImageResource(R.drawable.tap_red);
            dot_3_2.setImageResource(R.drawable.tap_red);
            dot_3_3.setImageResource(R.drawable.tap_red);
            dot_3_4.setImageResource(R.drawable.tap_red);
            dot_3_5.setImageResource(R.drawable.tap_red);
            ...
            dot_1_2.setImageResource(R.drawable.tap_green);
            dot_1_5.setImageResource(R.drawable.tap_green);
            dot_1_6.setImageResource(R.drawable.tap_green);
            dot_2_1.setImageResource(R.drawable.tap_green);
            dot_2_2.setImageResource(R.drawable.tap_green);
            dot_2_3.setImageResource(R.drawable.tap_green);
            dot_2_4.setImageResource(R.drawable.tap_green);
            dot_2_5.setImageResource(R.drawable.tap_green);
            dot_2_6.setImageResource(R.drawable.tap_green);
            dot_3_1.setImageResource(R.drawable.tap_green);
            dot_3_2.setImageResource(R.drawable.tap_green);
            dot_3_5.setImageResource(R.drawable.tap_green);
            dot_3_6.setImageResource(R.drawable.tap_green);
            dot_4_1.setImageResource(R.drawable.tap_green);
            dot_4_6.setImageResource(R.drawable.tap_green);
            ...
            dot_2_1.setImageResource(R.drawable.tap_yellow);
            dot_2_2.setImageResource(R.drawable.tap_yellow);
            dot_2_3.setImageResource(R.drawable.tap_yellow);
            dot_2_4.setImageResource(R.drawable.tap_yellow);
            dot_3_1.setImageResource(R.drawable.tap_yellow);
            dot_3_2.setImageResource(R.drawable.tap_yellow);
            dot_3_3.setImageResource(R.drawable.tap_yellow);
            dot_3_4.setImageResource(R.drawable.tap_yellow);
            dot_3_5.setImageResource(R.drawable.tap_yellow);
            ...
            dot_1_4.setImageResource(R.drawable.tap_red);
            dot_1_5.setImageResource(R.drawable.tap_red);
            dot_1_6.setImageResource(R.drawable.tap_red);
            dot_2_1.setImageResource(R.drawable.tap_red);
            dot_2_2.setImageResource(R.drawable.tap_red);
            dot_2_3.setImageResource(R.drawable.tap_red);
            dot_2_4.setImageResource(R.drawable.tap_red);
            dot_2_5.setImageResource(R.drawable.tap_red);
            ...
            dot_3_4.setImageResource(R.drawable.tap_red);
            dot_3_5.setImageResource(R.drawable.tap_red);
            dot_3_6.setImageResource(R.drawable.tap_red);
            dot_4_1.setImageResource(R.drawable.tap_red);
            dot_4_2.setImageResource(R.drawable.tap_red);
            dot_4_3.setImageResource(R.drawable.tap_red);
            dot_4_4.setImageResource(R.drawable.tap_red);
    ...
    public void correct(){
        ...
        if (visible_count == 0 ){
            ...
            if ( GameUtilities.gameLevel == 1 )
                GameUtilities.score_t = 36.5;
            else if ( GameUtilities.gameLevel == 2 )
                GameUtilities.score_t = 40.0;
            else if ( GameUtilities.gameLevel == 3 )
                GameUtilities.score_t = 43.5;
            else if ( GameUtilities.gameLevel == 4 )
                GameUtilities.score_t = 47.0;
            else if ( GameUtilities.gameLevel == 5 )
                GameUtilities.score_t = 50.5;
            else if ( GameUtilities.gameLevel == 6 )
                GameUtilities.score_t = 54.0;
            else if ( GameUtilities.gameLevel == 7 )
                GameUtilities.score_t = 57.5;
            else if ( GameUtilities.gameLevel == 8 )
                GameUtilities.score_t = 61.0;
            else if ( GameUtilities.gameLevel == 9 )
                GameUtilities.score_t = 66.0;
        }
